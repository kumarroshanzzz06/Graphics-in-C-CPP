...
v print()
{
	...
	SB(15);
	S(5);
	rectangle(1,1,638,455);
	rectangle(3,3,636,453);
	S(1);
	T(TF,HD,4);
	O(100,100,"CONGRATS !!!!");
...
char s_page()
{
	...
	S(12);
	T(SANS_SERIF_FONT,HD,4);
	O(35,360,"Press any key to start the Game KBC");
	while(!kbhit())
	{
		sound(137);
		delay(100);
	...
	outtextxy(1,20,"5 Answers Gives ONE FIVE STAR");
	outtextxy(230,140,"AND");
	outtextxy(1,240,"10 Answers Gives ONE TEN STAR");
	//S(14);
	outtextxy(45,400,"Press any key (A-Z) to proceed");
	}
	ch1=getch();
	K
	return ch1;
